...
This repo contains **real, copy-pasteable workflow scripts (apps)** for  
[Purposewrite](https://purposewrite.com) – a platform for building **human-in-the-loop (HITL) AI mini-apps** using a simple scripting language.
...
- Paste it into Purposewrite
- Run and tweak it for your own use cases
...
app-writing-app/
    ...
    purposewrite-app-writing-prompt-for-gemini.txt
    #use this to generated apps through an interactive process, without coding
